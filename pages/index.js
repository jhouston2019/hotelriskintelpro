      ...
      <main className="flex-1">
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6">
            ...
            {/* Live Dashboard Demo - Redesigned */}
            <div className="rounded-2xl border-2 border-gray-300 bg-white shadow-xl overflow-hidden">
              {/* Dashboard Header - Simplified */}
              <div className="bg-hrip-navy px-6 py-4 text-white border-b-2 border-gray-300">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs font-semibold opacity-75 mb-1 uppercase tracking-wide">Example Dashboard</p>
                    <h2 className="text-xl font-bold">85-Room Boutique Hotel</h2>
                  </div>
                  <div className="text-right">
                    <p className="text-xs opacity-75 mb-1">Risk Score</p>
                    <div className="inline-flex items-center gap-2 bg-red-500 px-3 py-1 rounded-lg">
                      <span className="font-bold text-lg">47/100</span>
                    </div>
                  </div>
                </div>
              </div>

              {/* Main Content - What to Fix FIRST */}
              <div className="p-6 bg-gray-50">
                {/* What to Fix - PROMINENT */}
                <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl border-3 border-orange-400 p-8 mb-6 shadow-lg">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900">What to Fix</h3>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3 bg-white rounded-lg p-4 border-2 border-orange-300">
                      <span className="flex-shrink-0 w-8 h-8 rounded-full bg-red-600 text-white flex items-center justify-center text-sm font-bold">1</span>
                      <span className="text-base text-gray-900 font-semibold pt-1">Increase BI coverage duration to 15 months</span>
                    </li>
                    <li className="flex items-start gap-3 bg-white rounded-lg p-4 border-2 border-orange-300">
                      <span className="flex-shrink-0 w-8 h-8 rounded-full bg-red-600 text-white flex items-center justify-center text-sm font-bold">2</span>
                      <span className="text-base text-gray-900 font-semibold pt-1">Increase property coverage to $18M</span>
                    </li>
                    <li className="flex items-start gap-3 bg-white rounded-lg p-4 border-2 border-orange-300">
                      <span className="flex-shrink-0 w-8 h-8 rounded-full bg-orange-600 text-white flex items-center justify-center text-sm font-bold">3</span>
                      <span className="text-base text-gray-900 font-semibold pt-1">Review ordinance & law coverage</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-white rounded-lg border border-gray-300 p-5">
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-sm font-bold text-gray-700 uppercase">Property Coverage</h3>
                      <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-bold">GAP</span>
                    </div>
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-600">Rebuild Cost</span>
                        <span className="font-bold text-gray-900">$17.4M</span>
                      </div>
                      <div className="pt-2 border-t border-red-200">
                        <div className="flex justify-between">
                          <span className="font-bold text-red-700">Uncovered</span>
                          <span className="text-xl font-bold text-red-600">$3.4M</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-300 p-5">
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-sm font-bold text-gray-700 uppercase">Business Interruption</h3>
                      <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-bold">GAP</span>
                    </div>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Coverage Duration</span>
                        <span className="font-bold text-orange-600">5 months</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="pt-2 border-t border-red-200">
                        <div className="flex justify-between">
                          <span className="font-bold text-red-700">Revenue at Risk</span>
                          <span className="text-xl font-bold text-red-600">$5.4M</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* Total Exposure - Simplified */}
              <div className="bg-red-600 px-6 py-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold mb-1 opacity-90">Total Uncovered Exposure</p>
                    <p className="text-5xl font-bold">$9.1M</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-semibold mb-1 opacity-90">Cost to Fix</p>
                    <p className="text-3xl font-bold">~$800/mo</p>
                  </div>
                </div>
              </div>
            </div>
